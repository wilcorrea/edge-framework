...
class Routes extends Router
{
    ...
    function get()
    {
        $dispatcher = FastRoute\simpleDispatcher(function(FastRoute\RouteCollector $r) {
            ...
            $r->addRoute('GET', '/example/pdf',
                '\App\Controller\home:dispatchPDF');
            $r->addRoute('GET', '/example/json',
                '\App\Controller\home:dispatchJson');
            ...
            $r->addRoute(['GET', 'POST'], '/example/users/add',
                '\App\Controller\users:add');
            $r->addRoute('GET', '/example/users/delete',
                '\App\Controller\users:delete');
        },
            [
